...
import ApartBlockPanel from './ApartBlockPanel.jsx';
    ...
    <div className="space-y-4">
      ...
      {status === 'done' && result && (
        <>
          ...
          {result.apartBlock && <ApartBlockPanel apartBlock={result.apartBlock} />}
          {!result.ok && !result.apartBlock && <UnlockPanel result={result} />}
        </>
      )}
    </div>
  );
