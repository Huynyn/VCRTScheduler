...
const roleColor = { supervisor: 'purple', returner: 'slate', rookie: 'gray' };
    ...
    <div className="flex items-center justify-between gap-3 px-4 py-3 hover:bg-gray-50 transition-colors">
      <div className="min-w-0">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {responder.gender === 'male' && <Badge color="blue">Male</Badge>}
          {responder.gender === 'female' && <Badge color="pink">Female</Badge>}
